...
let s:p.normal.left = [ [ s:magenta, s:base02 ], [ s:base00, s:base02 ] ]
let s:p.normal.right = [ [ s:base1, s:base03 ], [ s:base00, s:base03 ] ]
let s:p.inactive.right = [ [ s:base0, s:base02 ], [ s:base0, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base03 ], [ s:base0, s:base03 ] ]
let s:p.insert.left = [ [ s:orange, s:base02 ], [ s:base00, s:base02 ] ]
let s:p.replace.left = [ [ s:red, s:base02 ], [ s:base00, s:base02 ] ]
let s:p.visual.left = [ [ s:red, s:base02 ], [ s:base00, s:base02 ] ]
...
let g:lightline#colorscheme#bbsolarized#palette = lightline#colorscheme#flatten(s:p)
